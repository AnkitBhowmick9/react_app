...
get_users, get_candidates, get_open_jobs_with_candidates, register_candidate,\
...
urlpatterns = [
    ...
    path("open-jobs/", get_open_jobs_with_candidates, name="get_open_jobs"),
    path("register_candidate/", register_candidate, name="register_candidate"),
    path("candidate/<str:candidate_id>/update-client/", update_client_id),
    path("open-jobs/<str:job_id>/assign-candidate/", assign_candidate_to_job),
